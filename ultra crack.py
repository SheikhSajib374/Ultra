...
LIMITX=f"EXAMPLE : {G}100000{W},{G}50000{W},{G}100000{W},{G}150000{W},{G}200000{W}"
############------[ A SYS ]------#########
...
############------[ LOGO ]------#########
os.system('espeak -a 300 "ওয়েলকাম টু ,, সজীব সাইবার  আপডেট মেথড অন পয়েন্ট  ক্লোনিং টুলস11"')
def logo():
